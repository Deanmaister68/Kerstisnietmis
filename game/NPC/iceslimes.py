...
print("\nyou see it killing a rat whit a stream of ice extending from it. its blocking you're path to go further. You will kill it.")
def main():
    ...
    if turn == 1:
            ...
            player_turn = False
            computer_turn = True
            print("\nIce slime will go first.")


    print("\nPlayer health: ", player_health, "Ice slime health: ", computer_health)
    ...
    while (player_health != 0 or computer_health != 0):
            ...
            if player_turn:
                ...
                if miss:
                    ...
                    print("The Ice slime missed!")
                else:
                    if computer_health > 30: 
                        if player_health > 75:
                            computer_move = moves["Punch"]
                            print("\nThe Ice slime used Punch. It dealt ", computer_move, " damage.")
                            ...
                            print("\nThe Ice slime used ", imoves, ". It dealt ", computer_move, " damage.")
                        elif player_health <= 35:
                            computer_move = moves["Mega Punch"] # FINISH HIM!
                            print("\nThe Ice slime used Mega Punch. It dealt ", computer_move, " damage.")                       
                    else: # if the computer has less than 30 health, there is a 10% chance they will heal
                        heal_or_fight = random.randint(1,10) 
                        if heal_or_fight == 1:
                            heal_up = True
                            computer_move = moves["Heal"]
                            print("\nThe Ice slime used Heal. It healed for ", computer_move, " health.")
                        else:
                            if player_health > 75:
                                computer_move = moves["Punch"]
                                print("\nThe Ice slime used Punch. It dealt ", computer_move, " damage.")
    ...
    if winner == "Player":
            ...
            print("................................................................................")
            print("................................................................................")
            print("???: Sow you lost... I thought you " + inputplayername + " were thougher than this but weaklings dissepoint")
